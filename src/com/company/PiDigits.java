...
public class PiDigits {
    ...
    public static void allFinishedGetTime(){
        ...
        System.out.println("Calculation took : "+strDate);
    }
        ...
        for (int i = 0; i < nThreads ; i++) {
            new Thread(()-> {
                ...
                for (int j = 0; j < howManyTimes/nThreads; j++) {
                    ...
                    calcAndPrintPi(PiDigits.instanceCounter++);
                }
    ...
    public  void calcAndPrintPi(int callN){
        ...
        String s = "This is the call #"+callN+" ; "+ String.valueOf( new PiDigits().pi_digits(n)).substring(0,1)+"."+String.valueOf(new  PiDigits().pi_digits(n)).substring(1,32);
        //System.out.println("This is the call #"+callN+" ; "+ String.valueOf( PiDigits.pi_digits(n)).substring(0,1)+"."+String.valueOf( PiDigits.pi_digits(n)).substring(1,32));
    }

    public static void main(String[] args) {
        //SimpleDateFormat sdf = new SimpleDateFormat("HH:mm:ss.SSS");
        PiDigits.tsStart = new Date().getTime();
        //calcAndPrintPi(1);
        new PiDigits().threadPi(100000,10000);
